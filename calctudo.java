	...
	public static void main(String[] args) {
		...
		do {	
					...
					
				{
					...
					System.out.println(" O resultado da sua soma é " +df.format(alg1+alg2));
					System.out.println("");
					...
					
				{
					...
					System.out.println( "O resultado da sua subtração é : " +df.format(alg1-alg2));
					System.out.println("");
					...
					
				{
					...
					System.out.println(" O resultado da sua multiplicação é : " +df.format(alg1*alg2));
					System.out.println("");
				}
					...
					
				{
					...
					System.out.println(" O resultado da divisão é : " +df.format(alg1/alg2));
					System.out.println("");	
